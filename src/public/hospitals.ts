export interface PublicHospital {
  ...
  export const publicHospitals: PublicHospital[] = [
    // Level 6: National Referral Hospitals
    {
      ...
      level: 6,
      bedCapacity: 1800,
      specialties: "Cancer treatment, kidney dialysis, general surgery, teaching hospital"
    },
    {
      ...
      level: 6,
      bedCapacity: "Unknown",
      specialties: "General surgery, teaching hospital, serves Western Kenya and neighboring countries"
    },
    {
      ...
      level: 6,
      bedCapacity: 650,
      specialties: "Surgery, pediatrics, obstetrics, gynecology, psychiatry, cancer treatment"
    },
    {
    ...
    },
    {
      ...
      level: 6,
      bedCapacity: 650,
      specialties: "General medical services, referral for Nyanza and South Rift Valley"
    },
    ...
    // Level 5: County Referral Hospitals
    {
      ...
      level: 5,
      bedCapacity: "Unknown",
      specialties: "Maternal healthcare, dental care, VCT services, pediatrics, family planning"
    },
    {
      ...
      level: 5,
      bedCapacity: 700,
      specialties: "Maternal healthcare, pediatrics, laboratory services, dental care, renal healthcare"
    },
    {
